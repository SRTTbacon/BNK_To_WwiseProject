...
namespace BNKManager
{
    public class WPKSoundBank : LoLSoundBank
    {
        ...
        private void Write(BinaryWriter bw)
        {
            ...
            foreach (WPKSoundBankWEMFile wemFile in wemFiles)
            {
            ...
            foreach (WPKSoundBankWEMFile wemFile in wemFiles)
            {
                _ = bw.Seek((int)wemFile.fileInfoOffset, SeekOrigin.Begin);
        ...
        public class WPKSoundBankWEMFile
        {
            ...
            public WPKSoundBankWEMFile(BinaryReader br)
            {
                ...
                _ = br.BaseStream.Seek((int)fileInfoOffset, SeekOrigin.Begin);
                ...
                _ = br.BaseStream.Seek((int)dataOffset, SeekOrigin.Begin);
                data = br.ReadBytes((int)dataLength);
                _ = br.BaseStream.Seek(nextFileOffset, SeekOrigin.Begin);
            }
            public void Write(BinaryWriter bw)
            {
                ...
                _ = bw.Seek((int)dataOffset, SeekOrigin.Begin);
                bw.Write(data);
                _ = bw.Seek((int)nextFileOffset, SeekOrigin.Begin);
            }
        }
    }
}
...
namespace WoTB_Voice_Mod_Creater.Wwise_Class.BNK_To_Wwise_Project
{
    ...
    {
        private readonly Actor_Mixer Actor_Mixer_Project = new Actor_Mixer();
        private int Now_Extract_File_Count = 0;
        ...
        public void BNK_To_Wwise_Projects_Init(string Init_File, List<string> BNK_File, List<string> PCK_File = null, string SoundbanksInfo = null, bool IsNoSoundInfo = false)
        {
            ...
            Sub_Code.BNK_Parse_To_XML(Init_File, Sub_Code.Special_Path + "/Wwise_Parse/" + Temp_Name_01);
            BNK_Info.Init_Read_All.AddRange(File.ReadAllLines(Sub_Code.Special_Path + "/Wwise_Parse/" + Temp_Name_01 + ".xml"));
            File.Delete(Sub_Code.Special_Path + "/Wwise_Parse/" + Temp_Name_01 + ".xml");
            int Start_Line = -1;
            ...
            for (int Number = 0; Number < BNK_File.Count; Number++)
            {
                ...
                Sub_Code.BNK_Parse_To_XML(BNK_File[Number], Sub_Code.Special_Path + "/Wwise_Parse/" + Temp_Name);
                //解析に失敗していたら終了
                        ...
                        if (strValue2 == "CAkRanSeqCntr" || strValue2 == "CAkSwitchCntr" || strValue2 == "CAkSound" || strValue2 == "CAkLayerCntr" || strValue2 == "CAkActorMixer")
                        {
                            while ((line = file.ReadLine()) != null)
                            {
                                ...
                                if (line.Contains("name=\"DirectParentID\""))
                                {
                                    ...
                                    if (Enum.TryParse(strValue2, out CAkType Type))
        ...
        public async Task<bool> Create_Project_All(string To_Dir, bool IsExtractSound, TextBlock Message_T)
        {
            if (!IsSelected)
                return false;
            try
            {
                ...
                if (IsExtractSound)
                {
                    ...
                    while (!IsEnd)
                    {
                        Message_T.Text = "Extracting sound files...\nProgress:" + Now_Extract_File_Count + " / " + Max_Extract_File_Count;
                        await Task.Delay(1000);
                    }
                    Message_T.Text = "Converting to .wav format...";
                    await Multithread.Convert_Ogg_To_Wav(OGG_List, true);
                    OGG_List.Clear();
                }
                return true;
            }
        ...
        private void Create_Project_Directory(string To_Dir)
        {
            try
            {
                if (!Directory.Exists(To_Dir))
                    _ = Directory.CreateDirectory(To_Dir);
                File.Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Actor-Mixer Hierarchy\\Factory Motion.wwu", To_Dir + "\\Actor-Mixer Hierarchy\\Factory Motion.wwu", true);
                File.Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Actor-Mixer Hierarchy\\Factory SoundSeed Air Objects.wwu", To_Dir + "\\Actor-Mixer Hierarchy\\Factory SoundSeed Air Objects.wwu", true);
                File.Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Actor-Mixer Hierarchy\\Factory Synth One.wwu", To_Dir + "\\Actor-Mixer Hierarchy\\Factory Synth One.wwu", true);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Audio Devices", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Control Surface Sessions", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Conversion Settings", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Dynamic Dialogue", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Effects", To_Dir);
                File.Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Events\\Default Work Unit.wwu", To_Dir + "\\Events\\Default Work Unit.wwu", true);
                File.Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Game Parameters\\Default Work Unit.wwu", To_Dir + "\\Game Parameters\\Default Work Unit.wwu", true);
                _ = Directory.CreateDirectory(To_Dir + "\\GeneratedSoundBanks\\Windows");
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Interactive Music Hierarchy", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Mixing Sessions", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Modulators", To_Dir);
                _ = Directory.CreateDirectory(To_Dir + "\\Originals\\SFX");
                _ = Directory.CreateDirectory(To_Dir + "\\Originals\\Voices\\English(US)");
                _ = Directory.CreateDirectory(To_Dir + "\\Originals\\Voices\\ja");
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Presets", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Queries", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Soundcaster Sessions", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Triggers", To_Dir);
                Sub_Code.Directory_Copy(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Virtual Acoustics", To_Dir);
                Sub_Code.Create_WAV(Sub_Code.Special_Path + "\\Wwise\\Add_Empty_WAV_File_Temp.wav", 1.0);
                foreach (string To_File in BNK_Info.Add_Empty_Wav_Files)
                    if (!File.Exists(To_Dir + To_File))
                        File.Copy(Sub_Code.Special_Path + "\\Wwise\\Add_Empty_WAV_File_Temp.wav", To_Dir + To_File);
                File.Delete(Sub_Code.Special_Path + "\\Wwise\\Add_Empty_WAV_File_Temp.wav");
                List<string> Project_Main = new List<string>();
                List<string> Game_Parameter = new List<string>();
                Project_Main.AddRange(File.ReadAllLines(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\WoTB_Sound_Mod.wproj"));
                Game_Parameter.AddRange(File.ReadAllLines(Sub_Code.Special_Path + "\\Wwise\\WoTB_Sound_Mod\\Game Parameters\\Default Work Unit.wwu"));
        ...
        public List<string> Extract_WEM_To_Dir(string To_Project_Dir)
        {
            ...
            foreach (CAkSound Temp in BNK_Info.CAkSound_Info)
            {
                if (Temp.Language == "SFX")
                {
                    for (int Number = 0; Number < BNK_Info.BNK_File.Count; Number++)
                    {
                        _ = BNK_Info.BNK_File[Number].Wwise_Extract_To_Ogg_File(Temp.ShortID, To_Project_Dir + "\\Originals\\SFX\\" + Temp.ShortID + ".ogg", true);
                ...
                else
                {
                    for (int Number = 0; Number < BNK_Info.BNK_File.Count; Number++)
                    {
                        _ = BNK_Info.BNK_File[Number].Wwise_Extract_To_Ogg_File(Temp.ShortID, To_Project_Dir + "\\Originals\\Voices\\" + Temp.Language + "\\" + Temp.ShortID + ".ogg", true);
            ...
            if (BNK_Info.PCK_File != null)
            {
                foreach (CAkSound Temp in BNK_Info.CAkSound_Info)
                {
                    if (Temp.Language == "SFX")
                    {
                        for (int Number = 0; Number < BNK_Info.PCK_File.Count; Number++)
                        {
                            _ = BNK_Info.PCK_File[Number].Wwise_Extract_To_Ogg_File(Temp.ShortID, To_Project_Dir + "\\Originals\\SFX\\" + Temp.ShortID + ".ogg", true);
                            if (!Temp_List.Contains(To_Project_Dir + "\\Originals\\SFX\\" + Temp.ShortID + ".ogg"))
                                Temp_List.Add(To_Project_Dir + "\\Originals\\SFX\\" + Temp.ShortID + ".ogg");
                        }
                    }
                    else
                    {
                        for (int Number = 0; Number < BNK_Info.PCK_File.Count; Number++)
                        {
                            _ = BNK_Info.PCK_File[Number].Wwise_Extract_To_Ogg_File(Temp.ShortID, To_Project_Dir + "\\Originals\\Voices\\" + Temp.Language + "\\" + Temp.ShortID + ".ogg", true);
                            if (!Temp_List.Contains(To_Project_Dir + "\\Originals\\Voices\\" + Temp.Language + "\\" + Temp.ShortID + ".ogg"))
                                Temp_List.Add(To_Project_Dir + "\\Originals\\Voices\\" + Temp.Language + "\\" + Temp.ShortID + ".ogg");
                        }
                    }

...
namespace WoTB_Voice_Mod_Creater.Wwise_Class.BNK_To_Wwise_Project
{
    public class SoundbanksInfo
    {
        ...
        public static async Task Generate_Name(TextBlock Message_T)
        {
            for (int Number_01 = 0; Number_01 < BNK_Info.RTPC_Info.Count; Number_01++)
            {
                Message_T.Text = "Converting '" + BNK_Info.RTPC_Info[Number_01].ShortID + "' to a string...";
                await Task.Delay(50);
            ...
            for (int Number_01 = 0; Number_01 < Switch.Switch_Info.Count; Number_01++)
            {
                Message_T.Text = "Converting '" + Switch.Switch_Info[Number_01].ShortID + "' to a string...";
                await Task.Delay(50);
            ...
            for (int Number_01 = 0; Number_01 < Events.Event_Info.Count; Number_01++)
            {
                Message_T.Text = "Converting '" + Events.Event_Info[Number_01].ShortID + "' to a string...";
                await Task.Delay(50);
            ...
            for (int Number_01 = 0; Number_01 < State.State_All_Info.Count; Number_01++)
            {
                Message_T.Text = "Converting '" + State.State_All_Info[Number_01].Short_ID + "' to a string...";
                await Task.Delay(50);
            ...
            {
                Message_T.Text = "Converting '" + State.State_Child_Info[Number_01].Short_ID + "' to a string...";
                await Task.Delay(50);
        ...
        private static string Get_Value(string Read_Line)
        {
